                   ...
                   <div class="col-md-8 col-sm-7">
                       <div class="single-blog-body">
                            <div class="Leave-your-thought mt50">
                                <h3 class="aside-title uppercase book-details">My Bookings</h3>
                                <div class="row">
                                    <div class="col-md-12 col-sm-6 col-xs-12 lyt-left">
                                        <div class="book-box leave-ib">
                        ...
                        ?>
                                                ...
                                                <button class="btn btn-danger btn-sm">Not confirmed Yet</button>
                                            <!-- echo htmlentities("Not confirmed Yet"); -->

                                            <?php } else { ?>
                                            <button class="btn btn-success btn-sm"><?php echo $bstatus ?></button>
                                            <!-- echo htmlentities($bstatus); -->

                                            <?php }?></td>  
                                            <td>
                                            <a class="btn btn-info btn-sm" href="booking-details.php?bkid=<?php echo htmlentities($row->bid);?>">
