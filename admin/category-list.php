        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="add-category.php" type="submit" class="btn btn-info"><i class="fas fa-plus"></i>Add Category</a>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php } ?>
      ...
      ?>
                    ...
                    <td>
                      ...
                      <a href="category-list.php?del=<?php echo htmlentities($row->id);?>" onclick="return confirm('Are you sure you want to delete?');">
